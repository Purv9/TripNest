...
import HotelManagementDashboard from "./pages/dashboard/HotelManagementDashboard";
        ...
        <div className="min-h-screen flex flex-col">
          <Routes>
            ...
            <Route 
              ...
              element={
                <ProtectedRoute allowedRoles={['package-provider']}>
                  <PackageProviderDashboard />
                </ProtectedRoute>
              } 
            />
            <Route 
              path="/dashboard/hotel-management" 
              element={
                <ProtectedRoute allowedRoles={['hotel-management']}>
